...
## Project Structure
    ...
    ├── morning_waterfall_30060  # Django project configurations
...
1. Clone this repo and `cd morning_waterfall_30060`
...
2. Clone this repo and `cd morning_waterfall_30060`
